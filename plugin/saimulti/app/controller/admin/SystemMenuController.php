...
class SystemMenuController extends AdminController
{
     ...
     * @return Response
     */
    #[Permission('菜单数据列表', 'saimulti:admin:menu:index')]
     ...
     * @return Response
     */
    #[Permission('菜单数据读取', 'saimulti:admin:menu:read')]
     ...
     * @return Response
     */
    #[Permission('菜单数据添加', 'saimulti:admin:menu:save')]
     ...
     * @return Response
     */
    #[Permission('菜单数据修改', 'saimulti:admin:menu:update')]
     ...
     * @return Response
     */
    #[Permission('菜单数据删除', 'saimulti:admin:menu:destroy')]
