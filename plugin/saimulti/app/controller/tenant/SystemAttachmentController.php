 ...
 * 上传附件控制器
 */
class SystemAttachmentController extends TenantController
{
    /**
     * 构造
     */
     ...
     * @return Response
     */
    #[Permission('附件列表', 'saimulti:tenant:attachment:index')]
     ...
     * @return Response
     */
    #[Permission('附件数据修改', 'saimulti:tenant:attachment:edit')]
     ...
     * @return Response
     */
    #[Permission('附件数据删除', 'saimulti:tenant:attachment:destroy')]
     ...
     * @return Response
     */
    #[Permission('附件移动分类', 'saimulti:tenant:attachment:edit')]
