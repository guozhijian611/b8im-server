...
use plugin\saimulti\app\validate\system\SystemRoleValidate;
 ...
 * 角色控制器
 */
class SystemRoleController extends TenantController
{
    /**
     * 构造
     */
     ...
     * @return Response
     */
    #[Permission('角色数据列表', 'saimulti:tenant:role:index')]
     ...
     * @return Response
     */
    #[Permission('角色数据读取', 'saimulti:tenant:role:read')]
     ...
     * @return Response
     */
    #[Permission('角色数据添加', 'saimulti:tenant:role:save')]
     ...
     * @return Response
     */
    #[Permission('角色数据修改', 'saimulti:tenant:role:update')]
     ...
     * @return Response
     */
    #[Permission('角色数据删除', 'saimulti:tenant:role:destroy')]
     ...
     * @return Response
     */
    #[Permission('角色菜单权限', 'saimulti:tenant:role:menu')]
