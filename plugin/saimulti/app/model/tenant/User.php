...
{
    // 完整数据库表名称
    protected $table = 'sm_tenant_user';
    // 主键
    protected $pk = 'id';
    ...
    {
        $query->whereRaw('id in (SELECT user_id FROM sm_tenant_user_role WHERE role_id =?)', [$value]);
    }
    ...
    {
        return $this->belongsToMany(Post::class, UserPost::class, 'post_id', 'user_id');
    }
