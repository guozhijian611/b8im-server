...
-- ----------------------------
INSERT INTO `saimulti_table` VALUES (1, 'sm_article', '文章表', 'tenant', 'app', 'pms', '', 'article', 'Article', '文章管理', 4000, 'single', 1, 1, 'tenant-vue', 'index,save,update,read,destroy', 1, 800, 1, 24, '{\"relations\":[]}', NULL, 'mysql', NULL, NULL, '2026-04-15 17:09:07', '2026-04-24 17:18:45', NULL);
INSERT INTO `saimulti_table` VALUES (2, 'sm_article_category', '文章分类表', 'tenant', 'app', 'pms', '', 'category', 'ArticleCategory', '文章分类表', 4000, 'tree', 1, 1, 'tenant-vue', 'index,save,update,read,destroy', 1, 600, 1, 24, '{\"relations\":[],\"tree_id\":\"id\",\"tree_name\":\"category_name\",\"tree_parent_id\":\"parent_id\"}', NULL, 'mysql', NULL, NULL, '2026-04-16 13:06:00', '2026-04-24 16:56:59', NULL);
INSERT INTO `saimulti_table` VALUES (3, 'sm_tenant_group', '机构分组', 'admin', 'plugin', 'saimulti', 'admin', 'group', 'TenantGroup', '机构分组表', 4000, 'single', 1, 1, 'admin-vue', 'index,save,update,read,destroy', 2, 800, 1, 24, '{\"relations\":[]}', NULL, 'mysql', NULL, NULL, '2026-04-16 15:37:35', '2026-04-24 15:12:44', '2026-04-24 15:12:43');
INSERT INTO `saimulti_table` VALUES (4, 'sm_tenant_menu', '菜单信息表', 'admin', 'plugin', 'saimulti', 'admin', 'menu', 'TenantMenu', '菜单信息表', 4000, 'tree', 1, 1, 'admin-vue', 'index,save,update,read,destroy', 1, 600, 1, 24, '{\"relations\":[],\"tree_id\":\"id\",\"tree_parent_id\":\"parent_id\",\"tree_name\":\"name\"}', NULL, 'mysql', NULL, NULL, '2026-04-16 16:04:57', '2026-04-24 15:12:44', '2026-04-24 15:12:43');
INSERT INTO `saimulti_table` VALUES (5, 'sm_tenant_user', '用户信息表', 'admin', 'plugin', 'saimulti', 'admin', 'user', 'SmTenantUser', '用户信息表', 4000, 'single', 1, 1, 'admin-vue', 'index,save,update,read,destroy', 1, 600, 1, 24, '{\"relations\":[]}', NULL, 'mysql', NULL, NULL, '2026-04-16 16:05:19', '2026-04-24 15:12:44', '2026-04-24 15:12:43');
INSERT INTO `saimulti_table` VALUES (6, 'sm_system_organization', '机构信息表', 'admin', 'plugin', 'saimulti', 'admin', 'organization', 'SystemOrganization', '机构信息表', 4000, 'single', 1, 1, 'admin-vue', 'index,save,update,read,destroy', 1, 800, 1, 24, '{\"relations\":[]}', NULL, 'mysql', NULL, NULL, '2026-04-16 16:32:46', '2026-04-24 15:12:44', '2026-04-24 15:12:43');
INSERT INTO `saimulti_table` VALUES (7, 'sm_article_category', '文章分类表', 'tenant', 'app', 'cms', '', 'category', 'ArticleCategory', '文章分类表', 4000, 'single', 1, 1, 'tenant-vue', 'index,save,update,read,destroy', 1, 600, 1, 24, '{\"relations\":[]}', NULL, 'mysql', NULL, NULL, '2026-04-24 15:13:31', '2026-04-24 15:36:32', '2026-04-24 15:36:31');
INSERT INTO `saimulti_table` VALUES (8, 'sm_article_banner', '文章轮播图', 'tenant', 'app', 'pms', '', 'banner', 'ArticleBanner', '文章轮播', 4000, 'single', 1, 1, 'tenant-vue', 'index,save,update,read,destroy', 1, 600, 1, 24, '{\"relations\":[],\"tree_id\":\"id\",\"tree_name\":\"category_name\",\"tree_parent_id\":\"parent_id\"}', NULL, 'mysql', NULL, NULL, '2026-04-24 15:36:38', '2026-04-24 17:14:09', NULL);
...
INSERT INTO `sm_system_config` VALUES (10, 2, 'upload_size', '5242880', '上传大小', 'input', NULL, 88, '单位Byte,1MB=1024*1024Byte', NULL, NULL, NULL, '2026-04-14 21:59:03', NULL);
