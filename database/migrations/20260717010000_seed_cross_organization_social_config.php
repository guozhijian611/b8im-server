...
VALUES
  (%d, 'cross_org_social_enabled', '0', '允许跨租户好友与单聊', 'switch', '[{"label":"关闭","value":"0"},{"label":"开启","value":"1"}]', 100, '平台总开关。关闭时拒绝跨 organization 好友申请/接受与单聊发送；开启后允许并在跨租户联系人展示公司名称。', 1, 1, '%s', '%s')
SQL,
                $groupId,
                $now,
                $now,
